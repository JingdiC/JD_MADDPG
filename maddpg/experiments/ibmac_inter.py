...
from maddpg.maddpg.trainer.replay_buffer_with_messages import ReplayBuffer
...
class IBMACInterAgentTrainer(AgentTrainer):
    ...
    def action(self, obs_n, message_n, beta):
    ...
    def p_train_function(self, make_obs_ph_n, make_meesages_ph_n, act_space_n, p_func, q_func, optimizer,
